package com.xin.flowable.service.impl;
...
import com.xin.common.core.domain.model.LoginUser;
import com.xin.flowable.common.constant.ProcessConstants;
...
import com.xin.flowable.common.enums.FlowComment;
import com.xin.common.exception.CustomException;
import com.xin.common.utils.SecurityUtils;
import com.xin.flowable.domain.dto.FlowCommentDto;
import com.xin.flowable.domain.dto.FlowNextDto;
import com.xin.flowable.domain.dto.FlowTaskDto;
import com.xin.flowable.domain.dto.FlowViewerDto;
import com.xin.flowable.domain.vo.FlowQueryVo;
import com.xin.flowable.domain.vo.FlowTaskVo;
import com.xin.flowable.factory.FlowServiceFactory;
import com.xin.flowable.flow.CustomProcessDiagramGenerator;
import com.xin.flowable.flow.FindNextNodeUtil;
import com.xin.flowable.flow.FlowableUtils;
import com.xin.flowable.service.IFlowTaskService;
import com.xin.flowable.service.ISysDeployFormService;
import com.xin.flowable.service.ISysFormService;
import com.xin.system.domain.SysForm;
...
//        SysUser startUser = sysUserService.selectUserById(Long.parseLong(historicProcessInstance.getStartUserId()));
    ...
    public AjaxResult getNextFlowNodeByStart(FlowTaskVo flowTaskVo) {
        log.info("getNextFlowNodeByStart---------------->{}", JSONObject.toJSONString(flowTaskVo));
        ...
        log.info("getNextFlowNodeByStart--end---------------->{}", JSONObject.toJSONString(flowNextDto));
        return AjaxResult.success(flowNextDto);
    }
