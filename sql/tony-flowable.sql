...
-- ----------------------------
BEGIN;
INSERT INTO `sys_listener` (`id`, `name`, `type`, `event_type`, `value_type`, `value`, `create_time`, `update_time`, `create_by`, `update_by`, `status`, `remark`) VALUES (1, '任务监听', '1', 'assignment', '1', 'com.xin.flowable.listener.FlowTaskListener', '2022-12-25 12:31:50', NULL, NULL, NULL, 0, NULL);
INSERT INTO `sys_listener` (`id`, `name`, `type`, `event_type`, `value_type`, `value`, `create_time`, `update_time`, `create_by`, `update_by`, `status`, `remark`) VALUES (2, '执行监听', '2', 'start', '1', 'com.xin.flowable.listener.FlowExecutionListener', '2022-12-25 12:41:10', NULL, NULL, NULL, 0, NULL);
COMMIT;
...
INSERT INTO `sys_menu` (`menu_id`, `menu_name`, `parent_id`, `order_num`, `path`, `component`, `query`, `is_frame`, `is_cache`, `menu_type`, `visible`, `status`, `perms`, `icon`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`) VALUES (4, '若依官网', 0, 4, 'http://xin.vip', NULL, '', 0, 0, 'M', '0', '0', '', 'guide', 'admin', '2022-12-11 16:51:52', '', NULL, '若依官网地址');
